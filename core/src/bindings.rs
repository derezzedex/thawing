...
pub mod thawing {
    pub mod core {
            ...
            impl Closure {
                ...
                pub fn new() -> Self {
                    unsafe {
                        ...
                        let ret = wit_import();
                        Closure::from_handle(ret as u32)
                    }
                }
            }
            impl Closure {
        ...
        pub mod widget {
            ...
            pub type Message = super::super::super::thawing::core::host::Message;
            #[derive(Debug)]
            #[repr(transparent)]
            pub struct Button {
            ...
            impl Button {
                ...
                pub fn on_press(&self, message: Message) -> Button {
                    unsafe {
                        use super::super::super::thawing::core::host::Message as V0;
                        let (result1_0, result1_1) = match message {
                            V0::Toggled(e) => {
                                (
                                    0i32,
                                    match e {
                            ...
                            V0::Increment => (1i32, 0i32),
                            V0::Decrement => (2i32, 0i32),
                        };
                        #[cfg(target_arch = "wasm32")]
                        #[link(wasm_import_module = "thawing:core/widget")]
                        extern "C" {
            ...
            impl Checkbox {
                ...
                pub fn new(label: &str, is_checked: bool) -> Self {
                    unsafe {
                        ...
                        Checkbox::from_handle(ret as u32)
                    }
                }
            }
            impl Checkbox {
    ...
    pub mod thawing {
        pub mod core {
            ...
            pub mod runtime {
                ...
                pub type Message = super::super::super::super::thawing::core::host::Message;
                #[derive(Debug)]
                #[repr(transparent)]
                pub struct Table {
                ...
                impl Table {
                    ...
                    pub unsafe fn dtor<T: 'static>(handle: *mut u8) {
                        Self::type_guard::<T>();
                        let _ = _rt::Box::from_raw(handle as *mut _TableRep<T>);
                    }
                ...
                unsafe impl _rt::WasmResource for Table {
                    ...
                    unsafe fn drop(_handle: u32) {
                        ...
                        #[cfg(target_arch = "wasm32")]
                        {
                            #[link(wasm_import_module = "[export]thawing:core/runtime")]
                            extern "C" {
                ...
                pub unsafe fn _export_method_table_call_cabi<T: GuestTable>(
                    ...
                    #[cfg(target_arch = "wasm32")] _rt::run_ctors_once();
                    let result0 = T::call(
                        TableBorrow::lift(arg0 as u32 as usize).get(),
                        super::super::super::super::thawing::core::types::Closure::from_handle(
                            arg1 as u32,
                        ),
                    );
                    let ptr1 = _RET_AREA.0.as_mut_ptr().cast::<u8>();
                    use super::super::super::super::thawing::core::host::Message as V2;
                    match result0 {
                        V2::Toggled(e) => {
                ...
                pub unsafe fn _export_method_table_call_with_cabi<T: GuestTable>(
                    ...
                    use super::super::super::super::thawing::core::host::Message as V3;
                    match result1 {
                        V3::Toggled(e) => {
                ...
                #[doc(hidden)]
                #[macro_export]
                macro_rules! __export_thawing_core_runtime_cabi {
                    ($ty:ident with_types_in $($path_to_types:tt)*) => {
                        const _ : () = { #[export_name =
                        "thawing:core/runtime#[constructor]table"] unsafe extern "C" fn
                        export_constructor_table() -> i32 { $($path_to_types)*::
                        _export_constructor_table_cabi::<<$ty as $($path_to_types)*::
                        Guest >::Table > () } #[export_name =
                        "thawing:core/runtime#[method]table.call"] unsafe extern "C" fn
                        export_method_table_call(arg0 : * mut u8, arg1 : i32,) -> * mut
                        u8 { $($path_to_types)*:: _export_method_table_call_cabi::<<$ty
                        as $($path_to_types)*:: Guest >::Table > (arg0, arg1) }
                        #[export_name = "thawing:core/runtime#[method]table.call-with"]
                        ...
                        "thawing:core/runtime#[dtor]table"] #[allow(non_snake_case)]
                        unsafe extern "C" fn dtor(rep : * mut u8) { $($path_to_types)*::
                        Table::dtor::< <$ty as $($path_to_types)*:: Guest >::Table >
                        (rep) } }; };
                    };
                }
                #[doc(hidden)]
                pub use __export_thawing_core_runtime_cabi;
                #[repr(align(1))]
            ...
            pub mod guest {
                ...
                pub type State = super::super::super::super::thawing::core::host::State;
                #[derive(Debug)]
                #[repr(transparent)]
                pub struct App {
                ...
                #[doc(hidden)]
                #[allow(non_snake_case)]
                pub unsafe fn _export_constructor_app_cabi<T: GuestApp>() -> i32 {
                    #[cfg(target_arch = "wasm32")] _rt::run_ctors_once();
                    let result0 = App::new(T::new());
                    (result0).take_handle() as i32
                }
                #[doc(hidden)]
                #[allow(non_snake_case)]
                pub unsafe fn _export_method_app_view_cabi<T: GuestApp>(
                    ...
                    #[cfg(target_arch = "wasm32")] _rt::run_ctors_once();
                    let result0 = T::view(
                        AppBorrow::lift(arg0 as u32 as usize).get(),
                        super::super::super::super::thawing::core::host::State {
                            counter: arg1,
                            toggled: _rt::bool_lift(arg2 as u8),
                        },
                    );
                    (result0).take_handle() as i32
                }
                ...
                macro_rules! __export_thawing_core_guest_cabi {
                    ($ty:ident with_types_in $($path_to_types:tt)*) => {
                        ...
                        export_constructor_app() -> i32 { $($path_to_types)*::
                        _export_constructor_app_cabi::<<$ty as $($path_to_types)*:: Guest
                        >::App > () } #[export_name =
                        "thawing:core/guest#[method]app.view"] unsafe extern "C" fn
                        export_method_app_view(arg0 : * mut u8, arg1 : i64, arg2 : i32,)
                        -> i32 { $($path_to_types)*:: _export_method_app_view_cabi::<<$ty
                        as $($path_to_types)*:: Guest >::App > (arg0, arg1, arg2) } const
                        _ : () = { #[doc(hidden)] #[export_name =
                        "thawing:core/guest#[dtor]app"] #[allow(non_snake_case)] unsafe
                        extern "C" fn dtor(rep : * mut u8) { $($path_to_types)*::
                        App::dtor::< <$ty as $($path_to_types)*:: Guest >::App > (rep) }
                        }; };
                    };
                }
                #[doc(hidden)]
...
macro_rules! __export_thawing_impl {
    ...
    ($ty:ident with_types_in $($path_to_types_root:tt)*) => {
        $($path_to_types_root)*::
        exports::thawing::core::runtime::__export_thawing_core_runtime_cabi!($ty
        with_types_in $($path_to_types_root)*:: exports::thawing::core::runtime);
        $($path_to_types_root)*::
        ...
        "component-type:wit-bindgen:0.36.0:thawing:core:thawing:imports and exports"]
        #[doc(hidden)] pub static __WIT_BINDGEN_COMPONENT_TYPE : [u8; 2307] = *
        b"\
\0asm\x0d\0\x01\0\0\x19\x16wit-component-encoding\x04\0\x07\x85\x11\x01A\x02\x01\
A\x14\x01B\x14\x04\0\x07closure\x03\x01\x04\0\x07element\x03\x01\x01p}\x04\0\x05\
...
\x03\0\x12thawing:core/types\x05\0\x01B\x04\x01r\x02\x07counterx\x07toggled\x7f\x04\
\0\x05state\x03\0\0\x01q\x03\x07toggled\x01\x7f\0\x09increment\0\0\x09decrement\0\
\0\x04\0\x07message\x03\0\x02\x03\0\x11thawing:core/host\x05\x01\x02\x03\0\0\x07\
element\x02\x03\0\0\x07closure\x02\x03\0\0\x06pixels\x02\x03\0\0\x07padding\x02\x03\
\0\0\x06length\x02\x03\0\0\x0ahorizontal\x02\x03\0\0\x05color\x02\x03\0\x01\x07m\
essage\x01BM\x02\x03\x02\x01\x02\x04\0\x07element\x03\0\0\x02\x03\x02\x01\x03\x04\
\0\x07closure\x03\0\x02\x02\x03\x02\x01\x04\x04\0\x06pixels\x03\0\x04\x02\x03\x02\
\x01\x05\x04\0\x07padding\x03\0\x06\x02\x03\x02\x01\x06\x04\0\x06length\x03\0\x08\
\x02\x03\x02\x01\x07\x04\0\x0ahorizontal\x03\0\x0a\x02\x03\x02\x01\x08\x04\0\x05\
color\x03\0\x0c\x02\x03\x02\x01\x09\x04\0\x07message\x03\0\x0e\x04\0\x06button\x03\
\x01\x04\0\x08checkbox\x03\x01\x04\0\x06column\x03\x01\x04\0\x04text\x03\x01\x01\
i\x01\x01i\x10\x01@\x01\x07content\x14\0\x15\x04\0\x13[constructor]button\x01\x16\
\x01h\x10\x01@\x02\x04self\x17\x07message\x0f\0\x15\x04\0\x17[method]button.on-p\
ress\x01\x18\x01i\x03\x01@\x02\x04self\x17\x08on-press\x19\0\x15\x04\0\x1c[metho\
d]button.on-press-with\x01\x1a\x01@\x01\x04self\x17\0\x14\x04\0\x1b[method]butto\
n.into-element\x01\x1b\x01i\x11\x01@\x02\x05labels\x0ais-checked\x7f\0\x1c\x04\0\
\x15[constructor]checkbox\x01\x1d\x01h\x11\x01@\x02\x04self\x1e\x09on-toggle\x19\
\0\x1c\x04\0\x1a[method]checkbox.on-toggle\x01\x1f\x01@\x01\x04self\x1e\0\x14\x04\
\0\x1d[method]checkbox.into-element\x01\x20\x01i\x12\x01@\0\0!\x04\0\x13[constru\
ctor]column\x01\"\x01p\x14\x01@\x01\x08children#\0!\x04\0\x17[static]column.from\
-vec\x01$\x01h\x12\x01@\x02\x04self%\x06amount\x05\0!\x04\0\x16[method]column.sp\
acing\x01&\x01@\x02\x04self%\x07padding\x07\0!\x04\0\x16[method]column.padding\x01\
'\x01@\x02\x04self%\x05width\x09\0!\x04\0\x14[method]column.width\x01(\x01@\x02\x04\
self%\x06height\x09\0!\x04\0\x15[method]column.height\x01)\x01@\x02\x04self%\x05\
width\x05\0!\x04\0\x18[method]column.max-width\x01*\x01@\x02\x04self%\x05align\x0b\
\0!\x04\0\x16[method]column.align-x\x01+\x01@\x02\x04self%\x04clip\x7f\0!\x04\0\x13\
[method]column.clip\x01,\x01@\x02\x04self%\x05child\x14\0!\x04\0\x13[method]colu\
mn.push\x01-\x01@\x02\x04self%\x08children#\0!\x04\0\x15[method]column.extend\x01\
.\x01@\x01\x04self%\0\x14\x04\0\x1b[method]column.into-element\x01/\x01i\x13\x01\
@\x01\x08fragments\00\x04\0\x11[constructor]text\x011\x01h\x13\x01@\x02\x04self2\
\x04size\x05\00\x04\0\x11[method]text.size\x013\x01@\x02\x04self2\x05color\x0d\0\
0\x04\0\x12[method]text.color\x014\x01@\x01\x04self2\0\x14\x04\0\x19[method]text\
.into-element\x015\x03\0\x13thawing:core/widget\x05\x0a\x02\x03\0\0\x05bytes\x01\
B\x10\x02\x03\x02\x01\x03\x04\0\x07closure\x03\0\0\x02\x03\x02\x01\x0b\x04\0\x05\
bytes\x03\0\x02\x02\x03\x02\x01\x09\x04\0\x07message\x03\0\x04\x04\0\x05table\x03\
\x01\x01i\x06\x01@\0\0\x07\x04\0\x12[constructor]table\x01\x08\x01h\x06\x01i\x01\
\x01@\x02\x04self\x09\x01c\x0a\0\x05\x04\0\x12[method]table.call\x01\x0b\x01@\x03\
\x04self\x09\x01c\x0a\x05state\x03\0\x05\x04\0\x17[method]table.call-with\x01\x0c\
\x04\0\x14thawing:core/runtime\x05\x0c\x02\x03\0\x01\x05state\x01B\x0c\x02\x03\x02\
\x01\x02\x04\0\x07element\x03\0\0\x02\x03\x02\x01\x0d\x04\0\x05state\x03\0\x02\x04\
\0\x03app\x03\x01\x01i\x04\x01@\0\0\x05\x04\0\x10[constructor]app\x01\x06\x01h\x04\
\x01i\x01\x01@\x02\x04self\x07\x05state\x03\0\x08\x04\0\x10[method]app.view\x01\x09\
\x04\0\x12thawing:core/guest\x05\x0e\x04\0\x14thawing:core/thawing\x04\0\x0b\x0d\
\x01\0\x07thawing\x03\0\0\0G\x09producers\x01\x0cprocessed-by\x02\x0dwit-compone\
...
#[cfg(target_arch = "wasm32")]
#[link_section = "component-type:wit-bindgen:0.36.0:thawing:core:thawing-with-all-of-its-exports-removed:encoded world"]
#[doc(hidden)]
pub static __WIT_BINDGEN_COMPONENT_TYPE: [u8; 1996] = *b"\
\0asm\x0d\0\x01\0\0\x19\x16wit-component-encoding\x04\0\x07\xae\x0e\x01A\x02\x01\
...
\x04size\x05\00\x04\0\x11[method]text.size\x013\x01@\x02\x04self2\x05color\x0d\0\
0\x04\0\x12[method]text.color\x014\x01@\x01\x04self2\0\x14\x04\0\x19[method]text\
.into-element\x015\x03\0\x13thawing:core/widget\x05\x0a\x04\04thawing:core/thawi\
ng-with-all-of-its-exports-removed\x04\0\x0b-\x01\0'thawing-with-all-of-its-expo\
rts-removed\x03\0\0\0G\x09producers\x01\x0cprocessed-by\x02\x0dwit-component\x07\
